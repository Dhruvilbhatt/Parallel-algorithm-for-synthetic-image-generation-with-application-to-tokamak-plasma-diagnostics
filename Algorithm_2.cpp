...
int main()
{
    ...
    for(int x_static = 13; x_static <= 13; x_static++)
    {
        ...
        double *x_sp = new double [int(pixels)], *y_sp = new double [int(pixels)], *z_sp = new double [int(pixels)], *intensity_value = new double [int(pixels) * 8];
        ...
        #pragma omp parallel for schedule(dynamic, x_static) 
